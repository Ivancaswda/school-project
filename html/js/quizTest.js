...
let questions  = [
    ...
    {
        question: 'Почему у разных видов птиц <span class="Beak" style="color: white">разная</span>  форма клюва? ',

        answers: [
            {text: 'Просто так, мода', correct: false},
            {text: 'Чтобы отличаться от других видов', correct: false},
            {text: 'Для украшения брачных танцев', correct: false},
            {text: 'Потому что они едят разную пищу', correct: true},

        ]
    },
    {
        question: 'Чем отличается клюв хищной птицы от клюва травоядной?',

        answers: [
            {text: 'У хищника он острый и загнутый', correct: true},
            {text: 'У хищника он мягкий и круглый ', correct:false},
            {text: 'У травоядной клюв всегда чёрный', correct: false},
            {text: 'У  травоядной клюв светится в темноте', correct: false},

        ]
    },
    {
        question: 'Какая из этих функций  может быть у <span class="Beak" style="color: white"> клюва</span> у некоторых птиц?',

        answers: [
            {text: 'Улавливать сигналы Wi-Fi', correct: false},
            {text: 'Чистить перья', correct: true},
            {text: 'Ловить солнечные лучи для подзарядки', correct: false},
            {text: 'Раскрашивать гнездо', correct: false},
